...
// Kafka consumes protobuf-encoded OrderEvents from Redpanda/Kafka and
// auto-commits offsets after each successful handler invocation.
type Kafka struct {
	r   *kafka.Reader
	log *slog.Logger
}
